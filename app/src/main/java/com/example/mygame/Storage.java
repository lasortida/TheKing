...
//            }),
    ...
    public Relationship[][] relationships = {
            ...
            new Relationship[]{
                    new Relationship(5, "Гринленд - закрытая для внешенего мира страна! Но почему-то вас просят помочь и предоставить им нашу старую военную технику бесплатно!", new String[]{"Согласиться", "Отказаться"}, 0.2, -0.2)
            },
            new Relationship[]{
                    new Relationship(6, "Алмазная страна предлагает подписать договор о ежегодной поставке драгоценных металлов! Это может нам дорого обойтись! Подписываем?", new String[]{"Да", "Нет"}, 0.2, -0.2),
                    new Relationship(6, "У Алмазной страны возник конфликт с Каменией! Выберите кого вы хотите поддерживать!", new String[]{"Алмазная страна", "Камения"}, 0.2, -0.2),
                    new Relationship(6, "Алмазная страна решила провести военные испытания рядом с границей Гринленда! Был составлен международный акт с требованием отвести войска от границы!", new String[]{"Не подписывать акт", "Подписать акт"}, 0.2, -0.2),
                    new Relationship(6, "Правительство Алмазной страны отправило вам символический подарок!", new String[]{"Также отправить подарок", "Не отпарвлять подарка"}, 0.2, -0.2)
            }
    };
